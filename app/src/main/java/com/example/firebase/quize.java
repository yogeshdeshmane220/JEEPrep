...
public class quize extends AppCompatActivity {
    ...
    TextView text_clock, currentque;
    RadioGroup radioGroup;
    ArrayList<QuizeModel> list = new ArrayList<QuizeModel>();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        currentque = findViewById(R.id.currentQuestion);
...
/*   next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                currentque.setText(currentpos + 1 + "/ " + list.size());
...
//                questionno++;
        ...
        next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (currentpos == list.size() || currentpos >= list.size()) {
                    endQuiz();
                    delayStartScoreActivity();
                } else {
                    setdataToViews(currentpos);
...
//        list.add(new Model("Who developed the theory of relativity?", "Isaac Newton", "Albert Einstein", "Galileo Galilei", "Stephen Hawking", "Albert Einstein"));
//        list.add(new Model("What is the unit of electric power?", "Watt", "Volt", "Ampere", "Ohm", "Watt"));
//        list.add(new Model("Which metal is the best conductor of electricity?", "Gold", "Silver", "Copper", "Aluminum", "Silver"));
//        list.add(new Model("What is the chemical symbol for iron?", "Ag", "Fe", "Au", "Cu", "Fe"));
    ...
    private void delayStartScoreActivity() {
        ...
        new Handler().postDelayed(new Runnable() {
            @Override
            public void run() {
                startActivity(new Intent(quize.this, quize.class));
            }
        }, delayMilliseconds);
    }
